...
public class FJ_Derivatives implements PlugIn, WindowListener {
	...
	private static int xOrder;
	private static int yOrder;
	...
	public void run(String arg) {
		...
		String[]      orders = new String[11];
		for (int i = 0; i < 11; ++i) {
			orders[i] = String.valueOf(i);
		}
...
class FJDerivatives {
	...
	void run(ImagePlus imp, int xOrder, int yOrder, int zOrder, String scale) {
		try {
