...
public class NucleusSegmentationBatchDialog extends JFrame {
	...
	public NucleusSegmentationBatchDialog() {
		...
		Container          container;
		JLabel             jLabelXCalibration;
		JLabel             jLabelYCalibration;
		JLabel             jLabelZCalibration;
		JLabel             jLabelUnit;
		JLabel             jLabelSegmentation;
		JLabel             jLabelVolumeMin;
		JLabel             jLabelVolumeMax;
