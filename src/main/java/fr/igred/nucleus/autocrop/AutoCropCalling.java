...
public class AutoCropCalling {
	 ...
	 */
	private String processAutoCropWorkflow(File file) throws IOException, FormatException {
	 ...
	 */
	private String processAutoCropWorkflowOMERO(AutoCrop autoCrop, ImageWrapper image, Long[] outputsDatImages, Client client, String prefix, long outputProject)
	...
	public void runImageOMERO(ImageWrapper image, Long[] outputsDatImages, Client client)
		...
		this.outputCropGeneralInfo += processAutoCropWorkflowOMERO(autoCrop, image, outputsDatImages, client, prefix, outputProject);
	}
		...
		class ImageProcessor implements Runnable {
			...
			public void run() {
				try {
					...
					String info = processAutoCropWorkflowOMERO(autoCrop, image, outputsDatImages, client, prefix, finalOutputProject);
